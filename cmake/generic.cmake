...
function(cc_test_build TARGET_NAME)
  if(WITH_TESTING)
    ...
    get_property(os_dependency_modules GLOBAL PROPERTY OS_DEPENDENCY_MODULES)
    # paddle libs, gfalgs and glog removed
    target_link_libraries(${TARGET_NAME} ${cc_test_DEPS} ${os_dependency_modules} paddle_mpc_gtest_main gtest)
    add_dependencies(${TARGET_NAME} ${cc_test_DEPS} paddle_mpc_gtest_main gtest)
    common_link(${TARGET_NAME})
  endif()
endfunction()
