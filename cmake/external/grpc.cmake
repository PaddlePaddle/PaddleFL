...
ELSE()
  ...
  SET(GRPC_INSTALL_CMD make prefix=${GRPC_INSTALL_DIR} install-headers install-static install-plugins CFLAGS=${GRPC_CFLAGS} CXXFLAGS=${GRPC_CXXFLAGS})
ENDIF()
...
ExternalProject_Add(
    ...
    # 1. git clone -b v1.21.x https://github.com/grpc/grpc.git
    # 2. git submodule update --init
    # 3. keep only address_sorting, boringssl, cares, nanopb, objective_c, protobuf, zlib under "third_party",
    #    checkout and clean other dirs under third_party
    # 4. remove .git
    # 5. fix the ODR violations in libgrpc++ with the workaround from
    #    "https://github.com/grpc/grpc/issues/21213#issuecomment-554944145"
    # 6. fix the "argument list too long" issue via sightly modifying the Makefile
    # 7. package the directory
    URL          https://paddlefl.bj.bcebos.com/grpc-v1.21.x_paddlefl.tar.gz
    URL_MD5      03ef22469d57baccf0d46f807e0fe8f9
