...
from data.util import get_client_server_noniid_degree, get_global_distribution, \
    get_target_users_distribution, get_noniid_degree
import copy
import os
import time
...
class LotteryTicket(CentralTraining):
    ...
    def __init__(self, args, share_percent=0, iid=True, unequal=False, result_dir="lotteryticket",
        ...
        super(LotteryTicket, self).__init__(args, share_percent, iid, unequal, prune_interval,
                                            result_dir=result_dir, auto_mu=auto_mu,
