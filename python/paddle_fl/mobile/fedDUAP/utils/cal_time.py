...
name_dic1 = {
    ...
    f"{algo_name}_d2": ["central10_equal_l5_d0.900", "central10_equal_l5_d0.950",
                        "central10_equal_l5_d0.990", "central10_equal_l5_d0.999"],
    f"{algo_name}_d3": ["central10_equal_l10_d0.900", "central10_equal_l10_d0.950",
                        "central10_equal_l10_d0.990", "central10_equal_l10_d0.999"],
    f"{algo_name}_d1": ["central10_equal_l2_d0.900", "central10_equal_l2_d0.950",
                        "central10_equal_l2_d0.990", "central10_equal_l2_d0.999"],
    f"{prune_name}_with_dense": ["hrank10_equal_l5_nocenter_auto_with_dense_50"],
    f"{method_name}_with_dense": ["hrank10_equal_l5_d0.900_auto_with_dense", "hrank10_equal_l5_d0.950_auto_with_dense",
    ...
    f"{algo_name}_with_degree": ["central10_equal_l5_d0.900_with_degree", "central10_equal_l5_d0.900_with_degree",
                                 "central10_equal_l5_d0.900_with_degree", "central10_equal_l5_d0.900_with_degree"],

    "FedAvg_use_adam": "base10_equal_l5_use_adam",
    f"{algo_name}_use_adam": ["central10_equal_l5_d0.900_use_adam", "central10_equal_l5_d0.950_use_adam",
                              "central10_equal_l5_d0.990_use_adam", "central10_equal_l5_d0.999_use_adam"],

    "FedAvg_use_sgdm": "base10_equal_l5_use_sgdm",
    f"{algo_name}_use_sgdm": ["central10_equal_l5_d0.900_use_sgdm", "central10_equal_l5_d0.950_use_sgdm",
                              "central10_equal_l5_d0.990_use_sgdm", "central10_equal_l5_d0.999_use_sgdm"],

    f"{method_name}_use_sgdm": ["hrank10_equal_l5_d0.900_auto_use_sgdm", "hrank10_equal_l5_d0.950_auto_use_sgdm",
                                "hrank10_equal_l5_d0.990_auto_use_sgdm", "hrank10_equal_l5_d0.999_auto_use_sgdm"],

    "FedAvg_use_da": "base10_equal_l5_use_fsgdm",
    f"{algo_name}_use_da": ["central10_equal_l5_d0.900use_fsgdm", "central10_equal_l5_d0.950use_fsgdm",
                               "central10_equal_l5_d0.990use_fsgdm", "central10_equal_l5_d0.999use_fsgdm"],

    "FedAvg_use_globalm": "base10_equal_l5_use_globalm",
    f"{algo_name}_use_globalm": ["central10_equal_l5_d0.900_use_globalm", "central10_equal_l5_d0.950_use_globalm",
...
name_dic2 = {
    ...
    f"{prune_name}_with_dense": ["hrank10_equal_l5_nocenter_auto_with_dense_10", "hrank10_equal_l5_nocenter_auto_with_dense_30",
...
cmp6 = [f"{algo_name}_d1", f"{algo_name}_d2", f"{algo_name}_d3"]

cmp7 = [algo_name, prune_name, method_name]

cmp8 = [algo_name, prune_name, "PruneFL", "Hybrid-FL", "Data-sharing", "IMC", method_name]

cmp9 = [prune_name, f"{prune_name}_with_dense"]

cmp10 = [method_name, f"{method_name}_with_dense"]

cmp11 = [algo_name, f"{algo_name}_with_degree"]

cmp12 = [algo_name, f"{algo_name}_use_adam"]

cmp13 = [algo_name, f"{algo_name}_use_sgdm"]

cmp14 = [method_name, f"{method_name}_use_sgdm"]

cmp15 = ["Data-sharing", "Hybrid-FL", "IMC", "PruneFL", method_name]

cmp16 = [algo_name, f"{algo_name}_use_da"]

cmp17 = [algo_name, f"{algo_name}_use_globalm"]
...
def get_model_size(dir_name, percent):
    ...
    :return:
    """
    file_path = os.path.join(root_path, dir_name, "log", f"weights_{percent}.txt")
    print(file_path)
    if not os.path.exists(file_path):
        return [dict(), dict()]
    with open(file_path, "r") as f:
...
def plot_single_line(file_name, name, percent=0):
    ...
    msg2 = "finish time： {:.1f} final_flop: {} ({:.1f}%) final parameters {} ({:.1f}%) ".format(time[-1], round(final_flop / 1000000, 1),
