...
2. `python3 add2_share.py` 将双方本地数据拆分，得到data_C0_P0.npy、data_C1_P0.npy、data_C2_P0.npy、data_C0_P1.npy、data_C1_P1.npy、data_C2_P1.npy，同时会在命令行打印应当得到的乘法计算结果。
...
4. 需要预设好双方乘法的数据量大小，该参数为mul2_C0.py、mul2_C1.py、mul2_C2.py中第16行的num。
