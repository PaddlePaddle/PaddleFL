...
class TestOpBase(unittest.TestCase):
    ...
    def multi_party_run0(self, **kwargs):
        """
        Run 3 parties with target function or other additional arguments.
        :param kwargs:
        :return:
        ...
        parties = []
        kwargs.update({'role': 0})
        parties.append(Aby3Process(target=target, kwargs=kwargs))
        parties[-1].start()
        parties[-1].join()
        if parties[-1].exception:
            return parties[-1].exception
        return (True,)

    def multi_party_run1(self, **kwargs):
        """
        Run 3 parties with target function or other additional arguments.
        :param kwargs:
        :return:
    ...
    def multi_party_run2(self, **kwargs):
        """
        Run 3 parties with target function or other additional arguments.
        :param kwargs:
        :return:
