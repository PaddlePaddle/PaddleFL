...
class TestOpVariance3_C0(test_op_base.TestOpBase):
    ...
    def variance3_C0(self, **kwargs):

        role = 0
        d_1 = np.load('data_C0_P0_avg.npy',allow_pickle=True) #avg0
        d_2 = np.load('data_C0_P0_variance.npy',allow_pickle=True) #variance0
        d_3 = np.load('data_C0_P1_avg.npy',allow_pickle=True) #avg1
        d_4 = np.load('data_C0_P1_variance.npy',allow_pickle=True) #variance1
        d_5 = np.load('data_C0_P2_avg.npy',allow_pickle=True) #avg2
        d_6 = np.load('data_C0_P2_variance.npy',allow_pickle=True) #variance2
        d_tmp = np.load('data_C0_tmp.npy',allow_pickle=True) #tmp
    ...
    def test_variance3_C0(self):
        ret = self.multi_party_run0(target=self.variance3_C0)
