...
class TestOpVariance3_C2(test_op_base.TestOpBase):
    ...
    def variance3_C2(self, **kwargs):
        ...
        d_5 = np.load('data_C2_P2_avg.npy',allow_pickle=True) #avg2
        d_6 = np.load('data_C2_P2_variance.npy',allow_pickle=True) #variance2
    ...
    def test_variance3_C2(self):
        ret = self.multi_party_run2(target=self.variance3_C2)
